...
public class Card
{
    ...
    public Card(string externalId, int pokemonId, string name, string rarity, string imageUrl, string setName)
    {
        ...
        if (string.IsNullOrWhiteSpace(rarity)) throw new ArgumentException("Raridade é obrigatória", nameof(rarity));
    ...
    public void Update(string name, string rarity, string imageUrl, string setName)
    {
        if (string.IsNullOrWhiteSpace(name)) throw new ArgumentException("Nome é obrigatório", nameof(name));
        if (string.IsNullOrWhiteSpace(rarity)) throw new ArgumentException("Raridade é obrigatória", nameof(rarity));
        if (string.IsNullOrWhiteSpace(imageUrl)) throw new ArgumentException("Imagem Url é obrigatória", nameof(imageUrl));
